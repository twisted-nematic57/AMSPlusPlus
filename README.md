...
* [**Battery Cycle Tracker:**](battcycl) A small BASIC utility that allows you to track and visualize the cycling of your calculator's rechargeable batteries. Can also be used to visualize how often you throw away and replace alkaline batteries
  - Environmental Notice: Please use rechargeable NiMH batteries in your TI-68Ks whenever you can, as they are rather power-hungry devices.
* [**mQuickswap:**](mQuickswap) A very simple utility for quickly changing various mode settings on the calculator. Useful for quickly switching between DEG/RAD/GRAD, normal/scientific/engineering exponent notation, and real/complex/polar modes.
* [**scrcap:**](scrcap) An intuitive screenshotting tool for the TI-89/Titanium. Also includes a full-screen image viewing program.
...
They can most likely be ported to other platforms with little effort, however that has not been done yet as the author of most of these programs does not have a TI-92 [II/Plus]/Voyage 200.
